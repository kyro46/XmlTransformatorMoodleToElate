...
public class ElateXMLMain {
	...
	public static void main(String[] args) throws JAXBException, IOException {
		...
		result = result
				.replaceAll(
						" xmlns=\"\" xmlns:ns2=\"http://complex.taskmodel.thorstenberger.de/complexTaskDef\"",
						"");
	...
	public static byte[] startTransformToElateFormat(byte[] input_xml_content)
			throws JAXBException, IOException {

		// JAXB Context für Moodle-Quiz
		JAXBContext context_quiz = JAXBContext.newInstance(Quiz.class);
		Unmarshaller um_quiz = context_quiz.createUnmarshaller();
		Quiz quizsammlung = (Quiz) um_quiz.unmarshal(new ByteArrayInputStream(
				input_xml_content));
